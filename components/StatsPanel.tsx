        ...
        <div className="w-full max-w-5xl mx-auto">
            ...
            >
                ...
                >
                    ...
                    <motion.div
                        initial={{ width: 0 }}
                        animate={{ width: `${Math.min(100, Math.max(0, ((500 - (collectionStats?.totalListings || 424)) / 500) * 100))}%` }}
                    ...
                    <span className="absolute inset-0 flex items-center justify-center z-20 text-white font-cooper text-xl md:text-2xl tracking-wide drop-shadow-[0_0_20px_rgba(234,179,8,0.8)]">
                        {Math.round(((500 - (collectionStats?.totalListings || 424)) / 500) * 100)}% OF THE WAY THERE!
                    </span>
                </div>
            </motion.div>
